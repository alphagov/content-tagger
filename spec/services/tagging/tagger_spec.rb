RSpec.describe Tagging::Tagger do
  ...
  describe ".add_tags" do
    it "tags content to taxons" do
      ...
      described_class.add_tags(content_id, %w[ccc ddd], :taxons)
    ...
    it "tags content to organisations" do
      ...
      stub_any_publishing_api_patch_links
      described_class.add_tags(content_id, %w[dfid dwp], :organisations)
    ...
    it "retries 3 times" do
      ...
      expect { described_class.add_tags(content_id, %w[ccc], :taxons) }.not_to raise_error

      stub_any_publishing_api_patch_links.and_raise(GdsApi::HTTPConflict).times(3).then.to_return(body: "{}")
      expect { described_class.add_tags(content_id, %w[ccc], :taxons) }.to raise_error(GdsApi::HTTPConflict)
    end
  end
end
